...
| Analyze text | Transcript analysis produces suggested field fills |  |  |
...
| Review state | If transcript is changed after analysis, UI asks for re-analysis or primary-field insert |  |  |
...
| Mic denied | Manual transcript flow still works after microphone denial |  |  |
